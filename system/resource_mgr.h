...
#define PLATFORM_ETH_EVENTID_P1         49      /**< Ethernet Switch event - Used by NIMU library */
#define PLATFORM_ETH_INTERRUPT_P1       8       /**< Ethernet Switch Interrupt - Used by NIMU library */
